...
public class NaturalNumber3 extends NaturalNumberSecondary {
    ...
    public NaturalNumber3(int i) {
        ...
        this.createNewRep();
        if (i != 0) {
            //converts from int to string and concat to rep
    ...
    public NaturalNumber3(NaturalNumber n) {
        ...
        //calls initi representation
        this.createNewRep();

        //if n is zero or empty, rep will equal a string representation of n
        if (!n.isZero()) {
            this.rep = n.toString();
        }
    ...
    public final void multiplyBy10(int k) {
        ...
        /*
         * if k is greater than zero, and the length of rep is greater than or
         * equal to zero, add k to the end of rep.
         */
    ...
    public final int divideBy10() {
        ...
        if (!this.rep.equals("")) {
            lastDigit = this.rep.charAt(this.rep.length() - 1) - '0';
