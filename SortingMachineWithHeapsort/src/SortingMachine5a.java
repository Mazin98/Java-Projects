...
//                  entries with the right root
    ...
    public final T removeFirst() {
        ...
        //decrease heap size by one since we are removing node
        this.heapSize--;
        siftDown(this.heap, 0, (this.heapSize - 1) - 1, this.machineOrder);
        assert this.conventionHolds();
        return top;
    }
    ...
    public final int size() {
        ...
        int size; // Variable to hold the size of the SortingMachine

        /*
         * If the machine is in extraction mode, the size is determined by
         * heapSize
         */
        if (!this.insertionMode) {
            size = this.heapSize;
        ...
        /*
         * If the machine is in insertion mode, the size is determined by the
         * length of entries
         */
        else {
